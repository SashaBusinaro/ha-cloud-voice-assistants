# Getting Started with Cloud Voice Assistants

This guide will help you install and set up the Cloud Voice Assistants custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/SashaBusinaro/ha-cloud-voice-assistants`
6. Set category to "Integration"
7. Click "Add"
8. Find "Cloud Voice Assistants" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/SashaBusinaro/ha-cloud-voice-assistants/releases)
2. Extract the `cloud_voice_assistants` folder from the archive
3. Copy it to `custom_components/cloud_voice_assistants/` in your Home Assistant configuration directory
...
4. Select entities from "Cloud Voice Assistants"

Example entities card:

```yaml
type: entities
title: Cloud Voice Assistants
entities:
...
- Report issues at [GitHub Issues](https://github.com/SashaBusinaro/ha-cloud-voice-assistants/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/SashaBusinaro/ha-cloud-voice-assistants/discussions)
