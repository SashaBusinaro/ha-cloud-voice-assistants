...
This document describes the technical architecture of the Cloud Voice Assistants custom component for Home Assistant.

## Directory Structure

```text
custom_components/cloud_voice_assistants/
...
│   ├── __init__.py          # Exports CloudVoiceAssistantsDataUpdateCoordinator
...
│   ├── __init__.py          # Exports CloudVoiceAssistantsEntity
...
- `base.py` - Main coordinator class (`CloudVoiceAssistantsDataUpdateCoordinator`)
...
**Key class:** `CloudVoiceAssistantsDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `CloudVoiceAssistantsApiClient`
...
- `CloudVoiceAssistantsConfigFlowHandler` (main flow)
- `CloudVoiceAssistantsOptionsFlow` (options)
...
**Key class:** `CloudVoiceAssistantsEntity` (in `entity/base.py`)
...
2. `CloudVoiceAssistantsEntity` for common functionality
...
1. Create directory: `custom_components/cloud_voice_assistants/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `CloudVoiceAssistantsEntity`
