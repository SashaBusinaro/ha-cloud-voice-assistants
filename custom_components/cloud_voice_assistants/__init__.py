"""
Custom integration to integrate cloud_voice_assistants with Home Assistant.
...
https://github.com/SashaBusinaro/ha-cloud-voice-assistants
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = CloudVoiceAssistantsData(
        client=client,
