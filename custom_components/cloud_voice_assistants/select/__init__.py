"""Select platform for cloud_voice_assistants."""
...
from .fan_speed import ENTITY_DESCRIPTIONS as FAN_SPEED_DESCRIPTIONS, CloudVoiceAssistantsFanSpeedSelect
...
async def async_setup_entry(
    ...
    async_add_entities(
        CloudVoiceAssistantsFanSpeedSelect(
