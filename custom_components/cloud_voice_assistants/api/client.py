"""
API Client for cloud_voice_assistants.
...
class CloudVoiceAssistantsApiClientError(Exception):
    """Base exception to indicate a general API error."""


class CloudVoiceAssistantsApiClientCommunicationError(
    CloudVoiceAssistantsApiClientError,
):
    """Exception to indicate a communication error with the API."""


class CloudVoiceAssistantsApiClientAuthenticationError(
    CloudVoiceAssistantsApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        CloudVoiceAssistantsApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise CloudVoiceAssistantsApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class CloudVoiceAssistantsApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            CloudVoiceAssistantsApiClientAuthenticationError: If authentication fails.
            CloudVoiceAssistantsApiClientCommunicationError: If communication fails.
            CloudVoiceAssistantsApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise CloudVoiceAssistantsApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise CloudVoiceAssistantsApiClientError(
                msg,
            ) from exception
