...
if TYPE_CHECKING:
    ...
    from custom_components.cloud_voice_assistants.data import (
        CloudVoiceAssistantsConfigEntry,
    )
...
class CloudVoiceAssistantsConversationEntity(ConversationEntity):
    ...
    async def _async_handle_message(
        ...
        """Process a conversation turn using HA's ChatLog and the provider."""
