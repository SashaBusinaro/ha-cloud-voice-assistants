...
from custom_components.cloud_voice_assistants.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.cloud_voice_assistants.config_flow_handler.validators import validate_credentials
from custom_components.cloud_voice_assistants.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME
from homeassistant.loader import async_get_loaded_integration

if TYPE_CHECKING:
    from custom_components.cloud_voice_assistants.config_flow_handler.options_flow import CloudVoiceAssistantsOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "CloudVoiceAssistantsApiClientAuthenticationError": "auth",
    "CloudVoiceAssistantsApiClientCommunicationError": "connection",
}


class CloudVoiceAssistantsConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for cloud_voice_assistants.
    ...
    def async_get_options_flow(
    ...
    ) -> CloudVoiceAssistantsOptionsFlow:
        """
        ...
        """
        from custom_components.cloud_voice_assistants.config_flow_handler.options_flow import (  # noqa: PLC0415
            CloudVoiceAssistantsOptionsFlow,
        )

        return CloudVoiceAssistantsOptionsFlow()
