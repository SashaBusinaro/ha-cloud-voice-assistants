"""
Core DataUpdateCoordinator implementation for cloud_voice_assistants.
...
from custom_components.cloud_voice_assistants.api import (
...
class CloudVoiceAssistantsDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: CloudVoiceAssistantsConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except CloudVoiceAssistantsApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="cloud_voice_assistants",
                translation_key="authentication_failed",
            ) from exception
        except CloudVoiceAssistantsApiClientError as exception:
