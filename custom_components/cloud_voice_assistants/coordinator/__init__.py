"""
Data update coordinator package for cloud_voice_assistants.
...
from .base import CloudVoiceAssistantsDataUpdateCoordinator

__all__ = ["CloudVoiceAssistantsDataUpdateCoordinator"]
