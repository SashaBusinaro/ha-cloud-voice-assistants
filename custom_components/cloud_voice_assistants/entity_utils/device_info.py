"""Device info utilities for cloud_voice_assistants."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Cloud Voice Assistants",
        manufacturer=manufacturer or "Cloud Voice Assistants",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('cloud_voice_assistants', 'entry_id_value')}
    """
