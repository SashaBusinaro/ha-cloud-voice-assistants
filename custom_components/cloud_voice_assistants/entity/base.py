"""
Base entity class for cloud_voice_assistants.
...
from custom_components.cloud_voice_assistants.const import ATTRIBUTION
...
class CloudVoiceAssistantsEntity(CoordinatorEntity[CloudVoiceAssistantsDataUpdateCoordinator]):
    """
    Base entity class for cloud_voice_assistants.
