...
- Create new sensor file in `custom_components/cloud_voice_assistants/sensor/`
- Inherit from `CloudVoiceAssistantsEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Cloud Voice Assistants."""
...
class CloudVoiceAssistants[SensorName]Sensor(
...
- Entity: `custom_components/cloud_voice_assistants/sensor/[sensor_name].py`
- Platform: `custom_components/cloud_voice_assistants/sensor/__init__.py`
- Translations: `custom_components/cloud_voice_assistants/translations/*.json`
