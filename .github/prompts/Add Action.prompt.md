...
**File:** `custom_components/cloud_voice_assistants/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: cloud_voice_assistants
...
Create `custom_components/cloud_voice_assistants/service_actions/[action_name].py`:

```python
"""[Action name] service action for Cloud Voice Assistants."""
...
**File:** `custom_components/cloud_voice_assistants/__init__.py`
...
**File:** `custom_components/cloud_voice_assistants/const.py`
...
3. Find service action: `cloud_voice_assistants.[action_name]`
...
- **Service actions directory:** `custom_components/cloud_voice_assistants/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/cloud_voice_assistants/services.yaml` (legacy filename)
- **Icons:** `custom_components/cloud_voice_assistants/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/cloud_voice_assistants/translations/*.json` under `services` key (legacy)
