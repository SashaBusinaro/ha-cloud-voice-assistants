...
**Directory:** `custom_components/cloud_voice_assistants/[platform]/`
...
```python
"""[Platform] platform for Cloud Voice Assistants."""
...
from .entity import CloudVoiceAssistantsEntity
from .[entity_file] import CloudVoiceAssistants[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: CloudVoiceAssistantsDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            CloudVoiceAssistants[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Cloud Voice Assistants."""
...
class CloudVoiceAssistants[EntityName](
    CloudVoiceAssistantsEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/cloud_voice_assistants/manifest.json`:
...
- [ ] Entity class inherits from both `CloudVoiceAssistantsEntity` and platform class
...
- **Class prefix:** `CloudVoiceAssistants`
- **Base entity:** `CloudVoiceAssistantsEntity` in `entity/base.py`
- **Coordinator:** `CloudVoiceAssistantsDataUpdateCoordinator`
