...
- Inherit from `CloudVoiceAssistantsEntity` and platform base class
...
- Entity: `custom_components/cloud_voice_assistants/[platform]/[entity_name].py`
- Platform: `custom_components/cloud_voice_assistants/[platform]/__init__.py`
