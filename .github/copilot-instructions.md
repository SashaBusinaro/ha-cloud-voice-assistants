...
- **Main code:** `custom_components/cloud_voice_assistants/`
...
- `entity/` — Base entity class (`CloudVoiceAssistantsEntity`)
...
- Entity MRO: `(PlatformEntity, CloudVoiceAssistantsEntity)` — order matters
...
- Debug level: `custom_components.cloud_voice_assistants: debug` in `config/configuration.yaml`
