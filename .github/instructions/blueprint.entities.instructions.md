...
- **`entity/`** - Base entity classes (inherit `CloudVoiceAssistantsEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, CloudVoiceAssistantsEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import CloudVoiceAssistantsEntity`
