...
- `CloudVoiceAssistantsApiClientCommunicationError` (Network, timeout, HTTP errors)
- `CloudVoiceAssistantsApiClientAuthenticationError` (401, 403, invalid credentials)
